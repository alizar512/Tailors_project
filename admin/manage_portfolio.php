...
<head>
    <meta charset="UTF-8">
    <title>Portfolio: <?= htmlspecialchars($tailor['name']) ?> | Silah Admin</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light p-5">
    <div class="container bg-white p-5 rounded shadow-sm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>Portfolio: <?= htmlspecialchars($tailor['name']) ?></h2>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                <div class="card h-100">
                    <img src="<?= htmlspecialchars($img['image_url']) ?>" class="card-img-top" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
